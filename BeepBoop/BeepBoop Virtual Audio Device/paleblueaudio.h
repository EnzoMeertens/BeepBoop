...
#ifndef __PALEBLUEAUDIO_H_
#define __PALEBLUEAUDIO_H_
...
#define PALEBLUEAUDIO_VERSION               1
#define PALEBLUEAUDIO_REVISION              0

// Product Id
// {5B722BF8-F0AB-47ee-B9C8-8D61D31375A1}
#define STATIC_PID_PALEBLUEAUDIO 0x5b722bf8, 0xf0ab, 0x47ee, 0xb9, 0xc8, 0x8d, 0x61, 0xd3, 0x13, 0x75, 0xa1
DEFINE_GUIDSTRUCT("5B722BF8-F0AB-47ee-B9C8-8D61D31375A1", PID_PALEBLUEAUDIO);
#define PID_PALEBLUEAUDIO DEFINE_GUIDNAMED(PID_PALEBLUEAUDIO)

// Name Guid
// {946A7B1A-EBBC-422a-A81F-F07C8D40D3B4}
#define STATIC_NAME_PALEBLUEAUDIO 0x946a7b1a, 0xebbc, 0x422a, 0xa8, 0x1f, 0xf0, 0x7c, 0x8d, 0x40, 0xd3, 0xb4
DEFINE_GUIDSTRUCT("946A7B1A-EBBC-422a-A81F-F07C8D40D3B4", NAME_PALEBLUEAUDIO);
#define NAME_PALEBLUEAUDIO DEFINE_GUIDNAMED(NAME_PALEBLUEAUDIO)

// Pool tag used for MSVAD allocations
#define PALEBLUEAUDIO_POOLTAG           'INOS'  

// Debug module name
#define STR_MODULENAME              "PALEBLUEAudio: "
...
// Specific node numbers for beepboop.sys
