...
CPALEBLUEAudioHW::CPALEBLUEAudioHW()
: m_ulMux(0),
...
//=============================================================================
BOOL
CPALEBLUEAudioHW::bGetDevSpecific()
/*++
...
//=============================================================================
void
CPALEBLUEAudioHW::bSetDevSpecific
(
...
//=============================================================================
INT
CPALEBLUEAudioHW::iGetDevSpecific()
/*++
...
//=============================================================================
void
CPALEBLUEAudioHW::iSetDevSpecific
(
    IN  INT                 iDevSpecific
)
/*++
...
//=============================================================================
UINT
CPALEBLUEAudioHW::uiGetDevSpecific()
/*++
...
//=============================================================================
void
CPALEBLUEAudioHW::uiSetDevSpecific
(
...
//=============================================================================
LONG
CPALEBLUEAudioHW::GetMixerVolume
(   
    IN  ULONG                   ulNode,
    IN  LONG                    lChannel
)
...
//=============================================================================
void  
CPALEBLUEAudioHW::SetMixerVolume
(   
    IN  ULONG                   ulNode,
    IN  LONG                    lChannel,
    IN  LONG                    lVolume
